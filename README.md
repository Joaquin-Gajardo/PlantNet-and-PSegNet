...
[[10-minute presentation](https://www.bilibili.com/video/BV1EEaTedE4a/)]<br>
***
...
shade, high heat, high light, drought) during a 20-day growth period. In the total dataset, 312 point clouds are for tomato, 105 point clouds are for tobacco, and 129 point clouds are for sorghum.<br><br>
...
* folder [**models**] contains the code for PlantNet's entire training and testing processes.<br>
  ...
  * we also provide a well-trained PyTorch PlantNet model at epoch 199; the model was trained on a RTX3090 GPU with a batch size of 8. The model parameters were saved into a file "PlantNet/PlantNet_pytorch/models/checkpoints/model_epoch199.pth". The testing set that matches this already-trained PlantNet model is packaged at Original_Dataset/test.h5 for model_epoch199.pth.<br>
### PSegNet<br>
